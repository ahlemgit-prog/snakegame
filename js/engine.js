...
var Game = {
	...
	//Games variables
	Paused: true, //True the game is paused
	...
	Pause: function(){
		...
		$('#canvas-overlay').fadeIn('Vite');
		$('#overlay-text').text('Pause');
		Game.Paused = true;
	},
	...
	Lose: function(){
		...
		$('#overlay-text').html('Mince !<br><span class="small">Cliquez sur ENTER pour recommencer</span>');
		Game.Paused = true;
		Game.New = true;
